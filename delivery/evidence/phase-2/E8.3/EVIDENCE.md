...
**Story (verbatim):** As an RM, I want AI suggestions to become actions only through human confirmation (owner, priority, due date), with suggestions, edits, approvals, and rejections audited — accountability never transfers to the model.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an RM, I want AI suggestions to become actions only through human confirmation (owner, priority, due date), with suggestions, edits, approvals, and rejections audited — accountability never transfers to the model. | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
