...
**Story (verbatim):** As a QL, I want overdue actions visible on the Command Centre and in digests, and completed actions included in evidence packs.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As a QL, I want overdue actions visible on the Command Centre and in digests, and completed actions included in evidence packs. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
