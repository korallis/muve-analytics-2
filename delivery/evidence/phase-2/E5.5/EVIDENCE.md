...
**Story (verbatim):** As a QL, I want medication and care-task exceptions grouped by risk (given / refused / omitted / unavailable / late / undocumented as separate outcomes; PRN and repeat patterns identifiable), so genuine safety concerns are prioritised.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: genuine safety concerns are prioritised. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
