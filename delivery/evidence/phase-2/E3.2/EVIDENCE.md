...
**Story (verbatim):** As an SA, I want record-level ownership checks on every client-scoped read and mutation (ported 404-before-403 pattern).
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an SA, I want record-level ownership checks on every client-scoped read and mutation (ported 404-before-403 pattern). | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
