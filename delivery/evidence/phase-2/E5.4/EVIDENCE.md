...
**Story (verbatim):** As an OD, I want visit-delivery assurance: missed, late, shortened, cancelled, and incomplete visits distinguished from missing source data, with double-up visits handled correctly and actions available from any material exception.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an OD, I want visit-delivery assurance: missed, late, shortened, cancelled, and incomplete visits distinguished from missing source data, with double-up visits handled correctly and actions available from any material exception. | Visible acceptance text asserted as an OD; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
