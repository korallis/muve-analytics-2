...
**Story (verbatim):** As a QL, I want in-app safeguarding flagging preserved (app-owned table, alert-anchored) with exact counts when filtered to flagged.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As a QL, I want in-app safeguarding flagging preserved (app-owned table, alert-anchored) with exact counts when filtered to flagged. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
