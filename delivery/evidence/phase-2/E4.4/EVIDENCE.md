...
**Story (verbatim):** As a QL, I want threshold rules on any semantic metric (e.g., unresolved incidents >7 days, training compliance <95%) that raise risk items on the Command Centre.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As a QL, I want threshold rules on any semantic metric (e.g., unresolved incidents >7 days, training compliance <95%) that raise risk items on the Command Centre. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
