...
**Story (verbatim):** As an RM, I want estimated/keyword-derived metrics (RPI) permanently labelled as indicators at the definition level, so no screen can present them as audited counts.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: no screen can present them as audited counts. | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
