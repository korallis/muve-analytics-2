...
**Story (verbatim):** As a QL, I want the canonical incident record (§4.2) used everywhere, so totals and detail views always share one population definition, with structured follow-up states.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: totals and detail views always share one population definition, with structured follow-up states. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
