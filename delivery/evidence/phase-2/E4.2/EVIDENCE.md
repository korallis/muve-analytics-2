...
**Story (verbatim):** As a QL, I want the assurance matrix to model all 34 current quality statements with the correct domain distribution (Safe 8, Effective 6, Caring 5, Responsive 7, Well-led 8) and the six CQC evidence categories, with Inapplicable and Unknown as distinct statuses — fixing 1.0's scoring model.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As a QL, I want the assurance matrix to model all 34 current quality statements with the correct domain distribution (Safe 8, Effective 6, Caring 5, Responsive 7, Well-led 8) and the six CQC evidence categories, with Inapplicable and Unknown as distinct statuses — fixing 1.0's scoring model. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
