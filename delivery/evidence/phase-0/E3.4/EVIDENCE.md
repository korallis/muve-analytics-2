...
**Story (verbatim):** As an SA, I want Microsoft Entra ID SSO via the Auth.js provider when the organisation is ready, with an audited break-glass account.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an SA, I want Microsoft Entra ID SSO via the Auth.js provider when the organisation is ready, with an audited break-glass account. | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
