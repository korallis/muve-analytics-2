...
**Story (verbatim):** As an SA, I want E2E journey, accessibility (WCAG 2.2 AA), and AI-evaluation suites wired into CI (§9).
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an SA, I want E2E journey, accessibility (WCAG 2.2 AA), and AI-evaluation suites wired into CI (§9). | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
