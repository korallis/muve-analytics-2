...
**Story (verbatim):** As a QL, I want anomaly detection (incident spikes per client/category, DSO jumps, training-compliance drops) surfacing as risk items with an AI explanation.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As a QL, I want anomaly detection (incident spikes per client/category, DSO jumps, training-compliance drops) surfacing as risk items with an AI explanation. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
