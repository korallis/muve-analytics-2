...
**Story (verbatim):** As an RM, I want configurable escalation rules (deterministic conditions, auditable delivery and acknowledgement) so critical unresolved items cannot be ignored.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an RM, I want configurable escalation rules (deterministic conditions, auditable delivery and acknowledgement) so critical unresolved items cannot be ignored. | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
