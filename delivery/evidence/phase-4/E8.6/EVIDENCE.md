...
**Story (verbatim):** As an RM, I want per-client governance summaries and RPI impact reads carried forward (schema-validated JSON output pattern), regenerated only when underlying data changes.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an RM, I want per-client governance summaries and RPI impact reads carried forward (schema-validated JSON output pattern), regenerated only when underlying data changes. | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
