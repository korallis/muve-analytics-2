...
**Story (verbatim):** As an RM, I want goals, risks, and care-plan review dates monitored, with missing/overdue reviews as explicit exceptions; AI may summarise recorded progress but cannot infer an unrecorded outcome.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an RM, I want goals, risks, and care-plan review dates monitored, with missing/overdue reviews as explicit exceptions; AI may summarise recorded progress but cannot infer an unrecorded outcome. | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
