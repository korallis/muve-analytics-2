...
**Story (verbatim):** As an RM, I want auto-generated narrative on report surfaces (what changed, why it matters, what to do), cached by prompt-hash with TTL, degrading silently to no-narrative on failure.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an RM, I want auto-generated narrative on report surfaces (what changed, why it matters, what to do), cached by prompt-hash with TTL, degrading silently to no-narrative on failure. | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
