...
**Story (verbatim):** As an RM, I want statutory notifications and Duty of Candour steps tracked (applicability confirmed by a responsible person; deadlines, owners, evidence; AI-drafted correspondence stays an unsubmitted draft).
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an RM, I want statutory notifications and Duty of Candour steps tracked (applicability confirmed by a responsible person; deadlines, owners, evidence; AI-drafted correspondence stays an unsubmitted draft). | Visible acceptance text asserted as an RM; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
