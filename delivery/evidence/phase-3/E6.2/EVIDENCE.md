...
**Story (verbatim):** As an OD, I want safe-staffing metrics (missed/forced check-ins/outs, punctuality) with status-coverage % always shown next to forced counts, so denominators are honest.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: denominators are honest. | Visible acceptance text asserted as an OD; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
