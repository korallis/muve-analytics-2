...
**Story (verbatim):** As a QL, I want structured per-client RPI records (type, trigger, duration, technique, injury, de-escalation, debrief, outcome) with the AI impact read always labelled AI-derived, and repeated patterns and missing debriefs visible.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As a QL, I want structured per-client RPI records (type, trigger, duration, technique, injury, de-escalation, debrief, outcome) with the AI impact read always labelled AI-derived, and repeated patterns and missing debriefs visible. | Visible acceptance text asserted as a QL; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
