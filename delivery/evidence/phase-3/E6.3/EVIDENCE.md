...
**Story (verbatim):** As an OD, I want readiness and capacity: required vs scheduled vs delivered hours, availability, absence, and continuity (approved definition; agency vs substantive distinguishable), to spot uncovered visits and plan staffing.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an OD, I want readiness and capacity: required vs scheduled vs delivered hours, availability, absence, and continuity (approved definition; agency vs substantive distinguishable), to spot uncovered visits and plan staffing. | Visible acceptance text asserted as an OD; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
