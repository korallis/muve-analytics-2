...
**Story (verbatim):** As an SA, I want schema drift and load validation handled per §4.4, so a source change can never silently freeze or corrupt a table at app runtime.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: a source change can never silently freeze or corrupt a table at app runtime. | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
