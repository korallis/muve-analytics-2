...
**Story (verbatim):** As an SA, I want pipeline data tests (§4.4 step 5) on every load, and the semantic layer unit-tested (compiled SQL per metric against fixture marts).
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an SA, I want pipeline data tests (§4.4 step 5) on every load, and the semantic layer unit-tested (compiled SQL per metric against fixture marts). | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
