...
**Story (verbatim):** As an SA, I want Xero and Spendesk synced by the same pipeline framework, so finance data has the same freshness contract.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: finance data has the same freshness contract. | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
