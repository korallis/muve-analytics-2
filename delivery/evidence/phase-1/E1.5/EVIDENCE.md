...
**Story (verbatim):** As an SA, I want a rate-limited "Refresh now" button that triggers the incremental pipeline on demand.
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an SA, I want a rate-limited "Refresh now" button that triggers the incremental pipeline on demand. | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
