...
**Story (verbatim):** As an SA, I want every PR to get a Vercel preview with a Neon branch seeded from anonymised-but-realistic fixtures — review happens on real shapes, never production PII.

**Persona:** an SA  
**Route exercised:** /delivery-readiness  
...
|---|---|---|
| AC 1: The authorised persona can complete the stated outcome: As an SA, I want every PR to get a Vercel preview with a Neon branch seeded from anonymised-but-realistic fixtures — review happens on real shapes, never production PII. | Visible acceptance text asserted as an SA; policy and lineage footer present | 01-the-authorised-persona-can-complete-the-stat.png |
